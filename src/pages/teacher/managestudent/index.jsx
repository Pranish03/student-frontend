...
export default function ManageStudent() {
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside className="w-72 bg-white text-gray-800 p-4 border-r border-gray-200">
        <div className="mb-6">
      ...
      <div className="w-full min-h-screen p-6">
        ...
        <div className="flex justify-between items-center mb-5">
          <input
            type="text"
            placeholder="Search"
            className="w-1/3 mb-4 px-4 py-2 border border-gray-400 rounded"
          />
